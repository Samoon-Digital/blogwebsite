...
// src/index.ts
var app = new Hono2();
var SESSION_COOKIE = "samoondgital_session";
...
async function readSession(c) {
  const raw2 = await getSignedCookie(c, c.env.SESSION_SECRET, SESSION_COOKIE);
  if (!raw2) {
    return null;
  }
  try {
...
__name(shellStyles, "shellStyles");
          ...
          <aside class="sidebar">
            ...
            <footer>
              <div class="section" style="margin: 0;">
                ...
                <small style="color: var(--muted);">@${escapeHtml(user.username)} \xB7 ${escapeHtml(user.role)}</small>
              </div>
          ...
          <div class="content">
            <div class="topbar">
              <div>
                ...
                <div class="meta">Cloudflare-first admin panel \xB7 login protected by signed session cookie</div>
              </div>
...
// .wrangler/tmp/bundle-HcbAz4/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-HcbAz4/middleware-loader.entry.ts
